...
import { X, Bot, Zap, MessageSquare, Code, ExternalLink, Workflow, RefreshCw, Loader2 } from "lucide-react";
...
export function AgentTestChatModal({ open, onOpenChange, agent, canvasRef }: AgentTestChatModalProps) {
    ...
    const modalContent = (
        <>
            ...
            >
                {/* Header */}
                <div className="flex-shrink-0 p-5 bg-gradient-to-r from-[#1a1b26] to-[#282a36] border-b-2 border-[#282a36]">
                    <div className="flex items-start justify-between">
                            ...
                            <div className="flex items-center mb-1">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        {agent.model && (
                                            <span className="text-xs text-[#6272a4] bg-[#282a36] px-2 py-0.5 rounded-md">
                                                {agent.model}
                                            </span>
                                        )}
                                    </div>
                        ...
                        <div className="flex items-center space-x-2">
                            <button
                                ...
                                className="p-1.5 rounded-full hover:bg-[#282a36] text-[#6272a4] hover:text-[#bd93f9] transition-colors group relative"
                                title="Restart chat"
                                disabled={isInitializing}
                            >
                                <RefreshCw size={18} className={isInitializing ? "animate-spin text-[#50fa7b]" : ""} />
                                <span className="absolute -bottom-8 right-0 bg-[#282a36] text-[#f8f8f2] text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap">
                                    Restart chat
                                </span>
                            </button>
                            <button
                                onClick={() => onOpenChange(false)}
                                className="p-1.5 rounded-full hover:bg-[#282a36] text-[#6272a4] hover:text-[#ff5555] transition-colors group relative"
                            >
                                <X size={18} />
                    ...
                    {agent.description && (
                        <div className="mt-3 text-sm text-[#6272a4] bg-[#282a36]/50 p-3 rounded-md border border-[#282a36]">
                            {agent.description}
                        </div>
                    )}
                </div>
                ...
                {/* Chat content */}
                <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 bg-gradient-to-b from-[#0b0b11] to-[#1a1b26] custom-scrollbar" ref={messagesContainerRef}>
                    {isInitializing ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center px-6">
                            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#bd93f9]/20 to-[#bd93f9]/10 flex items-center justify-center shadow-lg mb-5 border border-[#bd93f9]/30">
                        ...
                        <div className="space-y-4 w-full max-w-full">
                            {messages.map((message) => {
                                ...
                                const agentColor = message.author === "user" ? "bg-[#bd93f9]" : "bg-gradient-to-br from-[#282a36] to-[#1a1b26]";
                                ...
                                return (
                                    <ChatMessageComponent
                                        ...
                                        avatarUrl={agent.avatar_url} // Corrected property name
                                    />
                                );
                            })}
                            ...
                            {isSending && (
                                <div className="flex justify-start">
                                    <div className="flex gap-3 max-w-[80%]">
                                        <Avatar
                                            className="bg-gradient-to-br from-[#bd93f9] to-[#bd93f9]/50 shadow-md border-0"
                                        >
                                            <AvatarFallback className="bg-transparent">
                                                <Bot className="h-4 w-4 text-white" />
                                            </AvatarFallback>
                                        </Avatar>
                                        <div className="rounded-lg p-3 bg-gradient-to-br from-[#282a36] to-[#1a1b26] border border-[#282a36]">
                ...
                {/* Message input */}
                <div className="p-3 border-t-2 border-[#282a36] bg-[#1a1b26]">
                    <ChatInput
