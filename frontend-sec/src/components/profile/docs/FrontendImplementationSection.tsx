...
export function FrontendImplementationSection({ copyToClipboard }: FrontendImplementationSectionProps) {
    return (
        <Card className="bg-[#282a36] border-[#bd93f9]/20 text-[#f8f8f2] shadow-[4px_4px_0px_0px_rgba(189,147,249,0.2)]">
            <CardHeader>
                <CardTitle className="text-[#bd93f9]">Frontend implementation</CardTitle>
            ...
            <CardContent className="space-y-6">
                <Tabs defaultValue="standard">
                    <TabsList className="bg-[#44475a]/50 border-[#44475a] mb-4">
                        <TabsTrigger value="standard" className="data-[state=active]:bg-[#bd93f9] data-[state=active]:text-black">
                            Standard HTTP
                        </TabsTrigger>
                        <TabsTrigger value="streaming" className="data-[state=active]:bg-[#bd93f9] data-[state=active]:text-black">
                            Streaming SSE
                        </TabsTrigger>
                        <TabsTrigger value="react-component" className="data-[state=active]:bg-[#bd93f9] data-[state=active]:text-black">
                            React component
                        </TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="standard">
                        <div>
                            <h3 className="text-[#50fa7b] text-lg font-medium mb-2">Implementation of message/send</h3>
  ...
  try {
    ...
    setIsLoading(false);
                    ...
                    <TabsContent value="streaming">
                        <div>
                            <h3 className="text-[#50fa7b] text-lg font-medium mb-2">Implementation of message/stream (Streaming)</h3>
                            <p className="text-[#f8f8f2]/80 mb-4">
  ...
  try {
    ...
    return null;
                    ...
                    <TabsContent value="react-component">
                        <div className="mt-4">
                            <h4 className="font-medium text-[#50fa7b] mb-2">React component with streaming support:</h4>
                            <div className="relative">
                                <CodeBlock
